...
\sout{ TPC is a part of a publicly available software package called \textsc{MLZ}%\footnote{http://pythonhosted.org/MLZ/} (Machine Learning for Photo-$z$).
}
...
In Table ? and ?, we present example.
}
