...
which are either stars or galaxies.\footnote{
\changed{
We exclude objects that clearly are neither stars nor galaxies.
...
They are also different from galaxies because of their intrinsic variability on
a wide range of time scales, which may be due to variation in the accretion rate
or instabilities of the accretion disk around the black hole
...
scheme
\citep[\eg][]{vasconcellos2011decision,Fadely2012}.
Expanding the historical star-galaxy classification problem to include
other classes may have advantanges~\citep{ball2006robust}, and we defer
the results of this multi-class problem to a future paper.}
}
...
layers after we find that adding more layers
...
is a feature map corresponding to the
