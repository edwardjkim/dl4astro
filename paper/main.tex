...
\textcolor{magenta}
{
I added colorbars. I don't see how I can reduce the whitespace further. I tried creating a ratio plot (see \url{https://github.com/EdwardJKim/dl4astro/blob/master/paper/figures/sdss_color_color.test.pdf}) but I think I prefer separate color-color diagrams for stars and galaxies. If you think the ratio plot is better, I can polish the linked ratio plot and replace the color-color diagrams with ratio plots.
}
...
The normalized kernel density estimate distributions for the training set
...
of objects in the test set as functions of $r$-band magnitude and $g-r$ color.
We do not show the distributions for the training and validation sets,
since the normalized kernel density estimate distributions for the training set
and validation sets are almost identical to those of the test set.
}
...
\RC{Why 1000 here?}
\textcolor{magenta}{It's somewhat arbitrary.  Number of ojbects in the test set / Number of bins in the calibration curve = 15000 / 10 = 1500.  So about 1000, rounded down.  But I could have chosen 100 or 10000 or any other number. Do you think I need a reason here?}
