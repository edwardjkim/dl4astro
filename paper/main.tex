...
\RC{FYI, a raw pixel value is observed directly from the telescope and is generally worthless. It must be reduced (correcting for the optics of the telescope and observational imprints) and calibrated (so that photon counts mean a physical value) before being useful in any sense.}
...
\begin{figure}
  ...
  \caption{
    ...
    galaxies in the CFHTLenS data set used in this analysis.
  }
