...
deep convolutional neural networks (ConvNets) directly on the raw pixel values.
...
kamdar2016machine1,kamdar2016machine2}, and
...
\begin{figure}
  ...
  \caption{
    Hexbin plots showing the color-color space distribution of stars and
    galaxies in the SDSS data set.
...
\begin{figure}
  ...
  \caption{
    Hexbin plots showing the color-color space distribution of stars and
    galaxies in the CFHTLenS data set.
  }
...
We note that training our network takes about 40 hours on a NVIDIA Tesla K40 GPU.
...
$\rmn{TPC}_{\rmn{phot}}$, as functions of $i$-band magnitude
...
and star completeness values for ConvNet, $\rmn{TPC}_{\rmn{morph}}$, and
$\rmn{TPC}_{\rmn{phot}}$ as
functions of $r$-band magnitude for the differential counts in the SDSS data.
