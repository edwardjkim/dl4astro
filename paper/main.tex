...
photometric estimation, and \citet{kim2015hybrid} for combining star-galaxy
classifiers).
}
...
of number of galaxies as performance metrics.
}
...
\changed{
    ...
    0.9972, 0.9963, and 0.9927 for ConvNet, TPC${}_{\rmn{morph}}$, TPC${}_{\rmn{phot}}$,
    respectively;
    for star purity $p_s=0.97$, we choose 0.6990, 0.5297, and 0.8570 for
    ConvNet, TPC${}_{\rmn{morph}}$, TPC${}_{\rmn{phot}}$, respectively.
}
  }
  \centering
...
ConvNet outperforms $\rmn{TPC}_{\rmn{morph}}$ in \changed{five} metrics
(AUC, $p_g$, CAL, $|\Delta N_g|/N_g$, \changed{and log loss}),
...
\changed{
    To obtain a galaxy completeness of $c_g=0.96$, we choose the threshold values
    0.7558, 0.9989, and 0.9360 for ConvNet, TPC${}_{\rmn{morph}}$, TPC${}_{\rmn{phot}}$,
    respectively;
  ...
  \begin{tabular}{l c c c c c c c}
    \hline
    classifier & AUC & MSE & $p_{g}(c_g=0.96) $ & $c_{s}(p_s=0.97)$ & CAL & $ |\Delta N_g|/N_g$ & \changed{log loss} \\
    \hline
    ConvNet               & 0.9952          & 0.0182          & 0.9915          & 0.9500          & \textbf{0.0243} & 0.0157 & \changed{\textbf{0.0731}} \\
    TPC${}_{\rmn{morph}}$ & \textbf{0.9967} & \textbf{0.0099} & \textbf{0.9977} & \textbf{0.9810} & 0.0254          & \textbf{0.0044} & \changed{0.0914} \\
    TPC${}_{\rmn{phot}}$  & 0.9886          & 0.0283          & 0.9819          & 0.8879          & 0.0316          & 0.0160 & \changed{0.1372} \\
    \hline
  \end{tabular}
...
\changed{
Furthermore, our ConvNet is a supervised algorithm; and one of the criticisms
...
spectroscopic sample, we have evaluated the performance on a test set
...
method) in this meta-classification framework will help improve the efficacy of
...
(\href{http://deeplearning.net/software/theano/}{http://deeplearning.net/software/theano/}),
the Lasagne library
(\href{http://lasagne.readthedocs.io/)}{http://lasagne.readthedocs.io/}),
and the Nolearn library
(\href{http://pythonhosted.org/nolearn/}{http://pythonhosted.org/nolearn/}).
}
